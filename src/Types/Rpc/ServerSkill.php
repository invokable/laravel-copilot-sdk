 ...
 */
readonly class ServerSkill implements Arrayable
{
    /**
     * @param  string  $name  Unique identifier for the skill
     * @param  string  $description  Description of what the skill does
     * @param  string  $source  Source location type (e.g., project, personal-copilot, plugin, builtin)
     * @param  bool  $userInvocable  Whether the skill can be invoked by the user as a slash command
     * @param  bool  $enabled  Whether the skill is currently enabled (based on global config)
     * @param  ?string  $path  Absolute path to the skill file
     * @param  ?string  $projectPath  The project path this skill belongs to (only for project/inherited skills)
     */
